...
void *chegada(void *arg) {
    ...
    printf("[LOG] Thread de chegada iniciada.\n");
    ...
    printf("[LOG] Chegada de uma thread completa.\n");

    if (chegadas == 2) {
        
        printf("[LOG] Ambas as threads de chegada finalizaram. Sinalizando para a thread de permanência.\n");
...
void *permanencia(void *arg) {
    ...
    printf("[LOG] Thread de permanência iniciada, aguardando threads de chegada.\n");
    ...
    printf("[LOG] Thread de permanência finalizada. Sinalizando para as threads de saída.\n");
...
void *saida(void *arg) {
    ...
    printf("[LOG] Thread de saída iniciada, aguardando sinal da permanência.\n");
    ...
    printf("[LOG] Thread de saída finalizou sua execução.\n");
